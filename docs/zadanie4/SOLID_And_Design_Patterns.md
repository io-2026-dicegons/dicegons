<h1> Zastsowanie zasady SOLID w naszym projekcie: </h1>  
...
Wzorzec ten określa pattern który ma strukturę drzewa, a kążdy obiekt jest dalej niezależnym obiektem nad który mmożna pracować osobno, mimo że jest zależny i połaczony z innymi. 
