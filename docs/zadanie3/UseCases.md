...
- **Wyjątki/ alternatywne scenariusze:**
4B. Wczytanie gry nie powiodło się. System przekazuje komunikat z błędem graczowi. Po potwierdzeniu następuje powrót do menu głównego.
...
5. Gracz wybiera opcję "Koniec tury"
6. System sprawdza, czy istnieje inny gracz posiadający prowincje (tj. nadal w rozgrywce). System przechodzi do kolejnej tury (dla innego gracza).
 **Wyjątki/ alternatywne scenariusze:**    
2B, 4B - Gracz wybiera opcję "Zakończ grę". System kończy obecną rozgrywkę i przechodzi do menu głównego. Koniec przypadku.
6B System wykrywa, że jeden gracz podbił wszystkie prowincje, osiągając tym samym zwycięstwo. System przekazuje informacje o końcu gry i rezultacie graczowi. Po potwierdzeniu przechodzi do menu głównego. Koniec przypadku.
